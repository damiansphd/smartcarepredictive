...
basefilename = sprintf('pmbfp%sst%sfd%dpd%dnm%dnw%dsf%dsw%dsl%dip%dau%dnb%dna%dnv%dnp%ddf%d', ...
        ...
        pmBaseFeatureParamsRow.augmethod,           pmBaseFeatureParamsRow.nbuckets, ...         
