...
basefilename = sprintf('pmfp_%s_st%s_fd%d_pd%d_rm%d_nm%d_bf%d_nb%d_sm%d_rn%d_vo%d_mf%d_dm%d', ...
        ...
        pmFeatureParamsRow.volfeat,             pmFeatureParamsRow.monthfeat, ...
        pmFeatureParamsRow.demofeat);
