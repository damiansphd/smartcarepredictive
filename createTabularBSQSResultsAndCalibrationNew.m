...
for i = 1:ncombinations
    ...
    featureparamsfile = generateFileNameFromFullFeatureParamsNew(featureparamsrow);
    ...
    load(fullfile(basedir, subfolder, modelparamsmatfile), 'pmModelRes', 'pmTrCVFeatureIndex', 'pmTestFeatureIndex', ...
        'pmTrCVExABxElLabels', 'pmTestExABxElLabels');
    ...
    [resultrow, resultstring] = setBSQSTableDisplayRowNew(featureparamsrow, modelparamsrow, pmBSAllQS(i).NDayQS, measures, nmeasures);
