function plotDWMeasuresAndPredictionsForPatientForPaper2(patientrow, pabs, pexsts, prawdata, pinterpdata, pinterpvoldata, ...
...
% plotDWMeasuresAndPredictionsForPatientForPaper - for a given patient, plot the measures along
...
ntitles = 1;
npredictions = 1;
tmpnmeasures = sum(measures.RawMeas | measures.Volatility | measures.PMean);
...
tmpmeasures = measures(measures.RawMeas | measures.Volatility | measures.PMean, :);
...
baseplotname1 = sprintf('%s-%s-P%d(%s%d)fP2', ...
