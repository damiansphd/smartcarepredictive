function plotDWModelWeights(pmModelRes, trfeatures, measures, nmeasures, ...
    featureparamsrow, modelparamsrow, lbdisplayname, plotsubfolder, basemodelresultsfile)

% plotDWModelWeights - plots the model weights for all prediction labels
...
for n = 1:1
    ...
    for fold = 1:nfolds
        ...
        hold on;
        nextfeat = 0.5;
        [xl1, yl1, nextfeat] = plotDWFeatureDividers(ax1(fold), featureparamsrow, measures, nmeasures, xl1, yl1, nextfeat, lcolor);
        hold off;
