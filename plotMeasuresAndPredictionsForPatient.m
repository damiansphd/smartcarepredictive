...
for m = 1:nmeasures
    ...
    [xl, yl] = plotMeasurementData(ax1(thisplot), days, applySmoothMethodToInterpRow(mdata, smfn, smwin, smln, measures.Index(m), mfev1idx), xl, yl, plottext, combinedmask, left_color, '-', 1.0, 'none', 1.0, 'blue', 'green');
