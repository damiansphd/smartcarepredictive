...
measures = table('Size',[nmeasures 9], ...
    'VariableTypes', {'double', 'cell', 'cell',        'cell',    'cell',      'double',  'double',     'double', 'double'}, ...
    'VariableNames', {'Index',  'Name', 'DisplayName', 'Column',  'ShortName', 'RawMeas', 'BucketMeas', 'Range',  'Volatility'});
