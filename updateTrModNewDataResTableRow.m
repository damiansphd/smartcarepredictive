function pmtrmodnewdatarow = updateTrModNewDataResTableRow(pmtrmodnewdatarow, pmFeatureParamsRow, ...
            ...
            datascope, daysscope, rundays, totdays, poslbldays, resstruct)
...
pmtrmodnewdatarow.PosLblDays    = poslbldays;
pmtrmodnewdatarow.PctPosLblDays = round(100 * poslbldays / rundays, 1);
