...
if smfunction > 0
    ...
    for p = 1:npatients
        ...
        for m = 1:nmeasures
            pmSmoothInterpNormcube(p,1:pmaxdays,m) = applySmoothMethodToInterpRow(pmInterpNormcube(p,1:pmaxdays,m), smfunction, smwindow, smlength, measures.Index(m), mfev1idx);
        end
    end
end
