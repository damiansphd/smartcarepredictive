...
[basefeatureparamfile, ~, ~, validresponse] = selectFeatureParametersNew(fv1name);
if ~validresponse
    return
end
...
for fs = 1:nfeatureparamsets
    ...
    for mp = 1:nmodelparamsets
        ...
        fbasefilename = generateFileNameFromFullFeatureParamsNew(pmThisFeatureParams(fs,:));
        ...
        if btmode == 1
            if runtype == 1
                ...
                [pmDayRes] = calcBSQualScores(pmDayRes, testlabels(origidx), nbssamples, norigex);
            end
        end
        ...
        save(fullfile(basedir, subfolder, outputfilename), ...
            ...
            'pmTestExABxElLabels', 'pmTestPatientSplit', ...
            'pmTrCVFeatureIndex', 'pmTrCVMuIndex', 'pmTrCVSigmaIndex', 'pmTrCVNormFeatures', ...
            'pmTrCVExABxElLabels', 'pmTrCVPatientSplit', ...
