...
pmPatientMeasStats = table('Size',[(npatients * nmeasures), 17], ...
    'VariableTypes', {'double', 'cell', 'double', 'double', 'cell', 'double', ...
    'double', 'double', 'double', 'double', 'double', 'double', 'double', ...
    'double', 'double', 'double', 'double'}, ...
    'VariableNames', {'PatientNbr', 'Study', 'ID', 'MeasureIndex', 'MeasureName', ...
    'Count', 'Mean', 'StdDev', 'Min', 'Max', 'RobustMin', 'RobustMax', ...
...
for p = 1:npatients
    ...
    for m = 1:nmeasures
        ...
        if (size(data,1) > 2)
            ...
            pmPatientMeasStats.RobustMin(row)    = robustmin(data);
            pmPatientMeasStats.RobustMax(row)    = robustmax(data);
