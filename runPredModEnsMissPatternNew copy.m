...
pmBaselineQS.PScore(1)      = pmMSRes.PScore;
pmBaselineQS.ElecPScore(1)  = pmMSRes.ElecPScore;
pmBaselineQS.AvgEpiTPred(1) = pmMSRes.AvgEpiTPred;
pmBaselineQS.AvgEpiFPred(1) = pmMSRes.AvgEpiFPred;
pmBaselineQS.AvgEPV(1)      = pmMSRes.AvgEPV;
pmBaselineQS.PRAUC(1)       = pmMSRes.PRAUC;
pmBaselineQS.ROCAUC(1)      = pmMSRes.ROCAUC;
pmBaselineQS.Acc(1)         = pmMSRes.Acc;
pmBaselineQS.PosAcc(1)      = pmMSRes.PosAcc;
pmBaselineQS.NegAcc(1)      = pmMSRes.NegAcc;
...
basedir = setBaseDir();
subfolder = 'MatlabSavedVariables';
outputfilename = sprintf('%s MPRes.mat', basemodelresultsfile);
