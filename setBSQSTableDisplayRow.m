...
resultrow = table('Size',[1 56], ...
    ...
    'VariableNames', {'FeatVer', 'ModelVer', 'StudyDisplayName', 'FeatureDuration', 'FeatFreq', 'LabelMethod', ...
                      'NormMethod', 'NormWindow', 'SmFunction', 'SmWindow', 'SmLength', 'InterpMthd', 'AugMthd', ...
...
resultstring = sprintf('pmfv%smv%sst%slm%d|fd%dff%s|nm%snw%d|sf%ssw%ssl%d|ip%dau%d|', resultrow.FeatVer{1}, resultrow.ModelVer{1}, ...
    ...
    resultrow.InterpMthd{1}, resultrow.AugMthd{1});
