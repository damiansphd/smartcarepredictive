...
resultrow = table('Size',[1 52], ...
    ...
    'VariableNames', {'FeatVer', 'ModelVer', 'StudyDisplayName', 'FeatureDuration', 'FeatFreq', 'LabelMethod', ...
                      ...
                      'PScore', 'ElecPScore', 'AvgEpiTPred', 'AvgEpiFPred', ...
...
resultstring = sprintf('pmfv%smv%sst%slm%d|fd%dff%s|nm%snw%d|sf%ssw%ssl%d|', resultrow.FeatVer{1}, resultrow.ModelVer{1}, ...
