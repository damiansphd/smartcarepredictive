...
elseif pmFeatureParamsRow.interpmethod == 2
    resultrow.InterpMthd = {'2:Limited'};
end

resultstring = sprintf('pmfv%smv%sst%slm%d|fd%dff%s|nm%snw%d|sf%ssw%ssl%dip%d|', resultrow.FeatVer{1}, resultrow.ModelVer{1}, ...
    resultrow.StudyDisplayName{1}, resultrow.LabelMethod, resultrow.FeatureDuration, resultrow.FeatFreq{1}, ...
    resultrow.NormMethod{1}, resultrow.NormWindow, resultrow.SmFunction{1}, resultrow.SmWindow{1}, resultrow.SmLength, resultrow.InterpMthd{1});
