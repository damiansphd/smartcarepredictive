...
if contains(filename, {'ScenR3.13f', 'ScenR4.13f', 'ScenR4.13g', 'ScenX1.4', 'ScenY1.4', 'CLScen1.1', 'CLScen1.2', 'BRScen1.1', 'BRScen1.2', 'BRScen1.3'})
    type = 1;
    doplot = true;
...
elseif contains(filename, {'ScenM3.4', 'ScenM3.5', 'ScenM3.6'})
    type = 3;
    doplot = true;
elseif contains(filename, {'BR1.4-Fig4E', 'BRv6-Fig4E'})
    type = 4;
    doplot = true;
else
    type = -1;
