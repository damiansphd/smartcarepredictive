...
% and set missing values to be equal to out of range constant).
% need to change this to use isnan for pmRawMeasFeats rather than
% missingness features
%pmRawMeasFeats(logical(pmMSFeats)) = basefeatparamsrow.msconst;
pmRawMeasFeats(logical(isnan(pmRawMeasFeats))) = basefeatparamsrow.msconst;
