function [resultrow, resultstring] = setDWBSQSTableDisplayRow(pmFeatureParamsRow, pmModelParamsRow, modeldayres, measures, nmeasures)
...
resultrow = table('Size',[1 43], ...
    'VariableTypes', {'cell', 'cell', 'cell', 'double', 'double', ...
                      ...
                      'double', 'double', 'double', ...
                      'double', 'double', 'double'}, ...
    'VariableNames', {'FeatVer', 'ModelVer', 'StudyDisplayName', 'DataWindow', 'LabelMethod', ...
...
resultrow.DataWindow  = pmFeatureParamsRow.datawinduration;
...
resultrow.NormWindow = pmFeatureParamsRow.normwinduration;
...
resultstring = sprintf('pmfv%smv%sst%slm%d|fd%d|nm%snw%d|sf%ssw%ssl%d|ip%sau%smc%dmi%s|', resultrow.FeatVer{1}, resultrow.ModelVer{1}, ...
    resultrow.StudyDisplayName{1}, resultrow.LabelMethod, resultrow.DataWindow, ...
