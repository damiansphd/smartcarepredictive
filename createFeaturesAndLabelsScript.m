...
for rp = 1:size(pmFeatureParams,1)
    ...
    [pmMuNormcube, pmSigmaNormcube] = createPMNormWindowcube(pmPatients, pmInterpDatacube, ...
        pmOverallStats, pmPatientMeasStats, pmFeatureParams.normmethod(rp), pmFeatureParams.normwindow(rp), ...
    ...
    save(fullfile(basedir, subfolder, outputfilename), ...
        ...
        'pmFeatureParams', 'rp', 'pmMuNormcube', 'pmSigmaNormcube', ...
