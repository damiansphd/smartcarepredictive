function pmMSModelRes = createMSModelResStuct(nexamples, nfolds)

% createMSModelResStuct - creates the model result structure for the
% missingness classifier

pmMSModelRes = struct('Folds'      , [], 'LLH', 0.0        , 'Pred'       , zeros(nexamples,1), ...
