...
outputfilename = sprintf('pmfp%sst%sfd%dff%dpd%dnm%dnw%dsf%dsw%dsl%dip%dau%dmc%dmi%drm%dms%dbf%dnb%drn%dvo%das%dna%dvs%dnv%dcc%dpm%dps%dbm%dbs%dnp%ddf%ddm%d', ...
        ...
        pmFeatureParamsRow.rawmeasfeat, ...
