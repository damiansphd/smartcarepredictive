...
for i = 1:ncombinations
    ...
    featureparamsfile = generateFileNameFromModFeatureParams(featureparamsrow);
    ...
    [resultrow, resultstring] = setDWBSQSTableDisplayRow(featureparamsrow, modelparamsrow, pmBSAllQS(i).NDayQS, measures, nmeasures);
